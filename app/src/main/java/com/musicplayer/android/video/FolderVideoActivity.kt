...
class FolderVideoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        templist.add(VideoContentData("","1","ScreenShot",0,"ScreenShot","2","", Uri.parse("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4")))
        templist.add(VideoContentData("","1","ScreenShot",0,"ScreenShot","2","", Uri.parse("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4")))
        templist.add(VideoContentData("","1","ScreenShot",0,"ScreenShot","2","", Uri.parse("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ElephantsDream.jpg")))
        templist.add(VideoContentData("","1","ScreenShot",0,"ScreenShot","2","", Uri.parse("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ForBiggerBlazes.jpg")))

        val position= intent.getIntExtra("position",0)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.title=FolderVideoFragment.folderList!![position].folderName
      //  currentFolderVideos=getAllVideo(FolderVideoFragment.folderList!![position].id)
        ...
        binding.totalVideo.text = "Total Videos : ${templist.size}"
    }
